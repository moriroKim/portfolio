          ...
          blocks: [
            {
              heading: "문제",
              body:
                "부모가 앱 차단이나 수면 시간을 설정하면 그 명령이 푸시로 자녀 단말에 갑니다. 그런데 푸시는 보장이 없습니다. 유실되면 부모 화면에는 차단이 걸려 있는데 단말에서는 아무 일도 일어나지 않은 상태가 됩니다. 다른 축의 문제도 있었습니다. 자녀가 접근성 권한을 꺼버리면 차단 자체가 무력화됩니다.",
            },
            {
              heading: "결정",
              body:
